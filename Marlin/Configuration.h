 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, 2.5, 0 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT  117.5//X_CENTER  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT  117.5//Y_CENTER  // Y point for Z homing
#endif
